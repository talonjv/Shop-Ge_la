...
function ProductItem({ product, navigate, setPreviewImage }) {
  // Lấy danh sách ảnh từ product.ImageURL
  let imageUrls = [];
  ...
  // State lưu chỉ số ảnh hiện tại và trạng thái hover
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [isHovered, setIsHovered] = useState(false);

  // Khi bỏ chuột, reset ảnh về ảnh đầu
  ...
  const goToDetailPage = () => {
    ...
    navigate(`/discount/${slug}/${encodedId}`);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Nút mũi tên trái/phải nếu có nhiều hơn 1 ảnh */}
...
export default function ProductPageSale() {
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row p-4">
        ...
        <div className="w-full md:w-3/4 p-4">
          ...
          <h1 className="text-2xl font-bold">Sản phẩm Giảm Giá</h1>
